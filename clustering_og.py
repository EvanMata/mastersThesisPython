...
def basic_ex(use_new_data=False, n_cs=5, save_centroids=False):
    """
    ...
    Inputs:
        ...
        save_centroids : bool - whether to save images of each centroid.
    """
    ys = []
    num_approx_zero_lamdbas = []
    if use_new_data:
        names_and_data = dg.genClusters(numClusters=n_cs, arraysPerCluster=3, n1=100, n2=100,
